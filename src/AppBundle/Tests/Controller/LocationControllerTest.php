...
class LocationControllerTest extends BaseTestCase {
    ...
    public function testUserIndex() {
        ...
        $this->assertEquals(0, $crawler->filter('.btn')->selectLink('New')->count());
    }
    ...
    public function testAdminIndex() {
        ...
        $crawler = $client->request('GET', '/location/');
        $this->assertStatusCode(200, $client);
        $this->assertEquals(1, $crawler->filter('.btn')->selectLink('New')->count());
    }
    ...
    public function testAnonTypeahead() {
        $client = $this->makeClient();
        $client->request('GET', '/location/typeahead?q=STUFF');
    ...
    public function testAnonNewPopup() {
        $client = $this->makeClient();
        $crawler = $client->request('GET', '/location/new_popup');
        $this->assertStatusCode(302, $client);
        $this->assertTrue($client->getResponse()->isRedirect());
    }
    ...
    public function testAnonDelete() {
        $client = $this->makeClient();
        $crawler = $client->request('GET', '/location/1/delete');
        $this->assertStatusCode(302, $client);
        $this->assertTrue($client->getResponse()->isRedirect());
    }
    ...
    public function testAdminDelete() {
        $preCount = count($this->em->getRepository(Location::class)->findAll());
        $client = $this->makeClient(LoadUser::ADMIN);
        $crawler = $client->request('GET', '/location/1/delete');
        $this->assertStatusCode(302, $client);
        $this->assertTrue($client->getResponse()->isRedirect());
