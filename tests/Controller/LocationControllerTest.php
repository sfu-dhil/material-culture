...
class LocationControllerTest extends ControllerBaseCase {
    ...
    public function testAnonTypeahead() {
        ...
        $this->client->request('GET', '/location/typeahead?q=STUFF');
    ...
    public function testAdminDelete() {
        $preCount = count($this->entityManager->getRepository(Location::class)->findAll());
        $this->login('user.admin');
        $crawler = $this->client->request('GET', '/location/1/delete');
        $this->assertEquals(302, $this->client->getResponse()->getStatusCode());
        $this->assertTrue($this->client->getResponse()->isRedirect());
        ...
        $postCount = count($this->entityManager->getRepository(Location::class)->findAll());
